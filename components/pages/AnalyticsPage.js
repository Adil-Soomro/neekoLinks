            ...
            <div className="grid gap-6 md:grid-cols-2">
                <div className="bg-white rounded-lg p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                        <DeviceStats icon={Laptop} label="Desktop" value={data.analytics.devices.desktop} />
                        <DeviceStats icon={Smartphone} label="Mobile" value={data.analytics.devices.mobile} />
                        <DeviceStats icon={Tablet} label="Tablet" value={data.analytics.devices.tablet} />
                    </div>
                </div>
                <TopRefferals />
            </div>
