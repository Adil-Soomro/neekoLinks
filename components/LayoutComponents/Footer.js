...
const Footer = () => {
  const footerLinks = {
    ...
    Contact: [
      {
        name: "support@neekolinks.com",
        href: "mailto:support@neekolinks.com",
      ...
      {
        name: "123 NeekoLinks St, Tech City",
        href: "#",
      ...
      <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-12 py-12 sm:py-16 lg:py-20">
          <div className="col-span-2 sm:col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <p
              className={`${josefin.className} text-gray-400 text-sm sm:text-base mb-6 sm:mb-8 max-w-md`}
            >
              Transform your long URLs into powerful, branded links. Track,
              analyze, and optimize your digital presence with NeekoLinks.
            </p>
          ...
          {Object.entries(footerLinks).map(([title, links], index) => (
            <div key={index} className="col-span-1">
              <h3 className="text-white font-semibold text-sm sm:text-base mb-4 sm:mb-6">
                {title}
              </h3>
