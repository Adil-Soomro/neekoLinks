...
const testimonials = [
  {
    ...
    text: "This service is amazing! It has made sharing links with my clients so much easier.",
  },
  {
    id: 2,
    name: "Jessica Patel",
    image: "/testimonials/jessica.png",
    text: "Quick, reliable, and secure. Couldn't ask for a better URL shortener.",
  },
  {
    id: 5,
    name: "Carlos Mendez",
    image: "/testimonials/carlos.jpg",
    text: "A game-changer! Managing links has never been this effortless.",
  },
  {
    id: 4,
    name: "Sophia Wong",
    image: "/testimonials/sophia.jpg",
    text: "Absolutely love how intuitive and fast this service is. Highly recommend!",
  },
  {
    id: 3,
    name: "David Kim",
    image: "/testimonials/david.png",
    text: "A must-have tool for anyone who works with links frequently.",
  },
  {
    id: 6,
    name: "Emily Parker",
    image: "/testimonials/emily.jpg",
    text: "A great tool that saves me so much time!",
  },
];
    ...
    <div className="max-w-5xl mx-auto py-12 px-6 text-center bg-gray-50 rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="relative w-full overflow-hidden">
        <motion.div
          ...
          drag="x"
          dragConstraints={{
            left: -300 * (testimonials.length - visibleItems),
            right: 0,
          }}
          animate={{ x: -index * 300 }}
        ...
        >
          {testimonials.map((item) => (
            ...
            >
              <img
                className="w-36 h-36 mx-auto rounded-full border-4 border-gray-200 mb-4 object-cover"
                src={item.image}
                alt={item.name}
              />
