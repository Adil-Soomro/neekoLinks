...
export default function HelpCenter() {
      ...
      questions: [
        {
          ...
          answer:
            "Click the 'Sign Up' button in the top right corner. You can register using your email address or social media accounts.",
        },
        {
          id: "first-link",
          question: "How to create my first shortened link?",
          answer:
            "After logging in, paste your long URL into the input field on the dashboard and click 'Shorten URL'. You can customize the link if desired.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "Go to the login page and click 'Forgot Password'. Enter your email to receive a password reset link.",
        },
        {
          id: "delete-account",
          question: "How do I delete my account?",
          answer:
            "Navigate to Account Settings > Danger Zone > Delete Account. Note this action is irreversible.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "Yes! Pro users can create custom aliases for their links. Go to Advanced Options when creating a link.",
        },
        {
          id: "analytics",
          question: "How to view link analytics?",
          answer:
            "All your links show basic analytics on the dashboard. Click any link to see detailed statistics.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "First check the original URL for validity. If issues persist, contact our support team with the link details.",
        },
        {
          id: "spam",
          question: "How to report spam/malicious links?",
          answer:
            "Use the 'Report Link' form on our website. We investigate all reports within 24 hours.",
        },
      ],
    },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ToastError(data.message || "Something gone wrong try again.");
        return;
      }
      ...
      ToastError(error.message || "Something gone wrong try again.");
    } finally {
      setLoading(false);
    }
  };
